...
<h4>SELECT column_name(s) FROM table_name WHERE column_1 = value_1 AND column_2 =
value_2;</h4>
<h4>Select gender from Person</h4>

<h2>AS</h2>
AS is a keyword in SQL that allows you to rename a column or table using an alias.
<h4>SELECT column_name AS 'Alias' FROM table_name;</h4>
<h2>AVG()</h2>
